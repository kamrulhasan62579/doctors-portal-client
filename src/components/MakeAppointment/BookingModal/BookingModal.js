  ...
  return (
    <div className="col-10 col-sm-9 col-md-6 col-lg-6 col-xl-4 col-xxl-4">
      {dateState ? (
        ...
        >
          <h5 style={{ color: "#5FC7C7", textAlign: "center" }}>
            {cardData.subject}
          </h5>
          {dateState && (
            <p className="text-center">
              <small>On {dateState.toDateString()}</small>
            </p>
          )}
          <form
        ...
        >
          <form
            ...
            onSubmit={handleSubmit(onSubmit)}
          >
            <h5 style={{ color: "red", alignItems: "center" }}>
              Select a date for your appointment!!! Something went wrong.{" "}
            </h5>
            <br />
            <button
